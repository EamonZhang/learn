...
//BD17E010A72BD2EBEA9E5F259E9F1E84F70DCA31
        return sign;
    }
    ...
    public static String getQueryString(String appKey, String secret, Map<String, String> paramMap)
    {
        ...
        //2ACDF74774727367335C8D71E7CD27B01A3F9DAB&city=%E4%B8%8A%E6%B5%B7
        // 添加签名
        StringBuilder stringBuilder = new StringBuilder();
    ...
    public static String requestApi(String apiUrl, String appKey, String secret, Map<String, String> paramMap)
    {
        ...
        try
        {
            ...
            client.getHostConfiguration().setProxy("192.168.6.228", 808);
...
//            client.getHostConfiguration().setHost("192.168.6.228", 808);
